...
<body>
  <div class="page">
    ...
    <p style="margin-top:16px;font-size:11px;color:#9CA3AF;">Generated by ClinicMD &nbsp;·&nbsp; ${new Date().toLocaleDateString('en-GB', { day:'numeric', month:'short', year:'numeric', hour:'2-digit', minute:'2-digit' })}</p>
  </div>
</body>
</html>`;
