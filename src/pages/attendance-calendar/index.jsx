          ...
          return (
            <div key={idx} className={`flex items-center justify-center aspect-square ${large ? 'p-1' : 'p-px'}`}>
              <div
                ...
                style={{
                  backgroundColor: isToday ? '#0F6E8C' : (bg || 'transparent'),
  ...
  const handleExportHTML = () => {
    ...
    const cellColor = (status) => {
      switch (status) {
        ...
        case '1st-Half Day':
        case '2nd-Half Day':                 return '#0F6E8C99';
      ...
      return `
        <tr>
          <td style="position:sticky;left:0;background:${rowBg};padding:8px 16px;border-right:1px solid #E1E3E5;white-space:nowrap;z-index:1;">
            ...
            <div style="font-size:10px;color:#9CA3AF;margin-top:1px;">${s.isTreatmentStaff ? 'Treatment' : 'Support'}</div>
          </td>
          ${dayCells}
...
<body>
  <div class="page">
    ...
    <div class="summary">
      ...
      <div class="summary-item"><span class="val" style="color:#0F6E8C">${totals.halfDay}</span><span class="lbl">Half Day</span></div>
    </div>
    ...
    <p style="margin-top:16px;font-size:11px;color:#9CA3AF;">Generated by Superdental &nbsp;·&nbsp; ${new Date().toLocaleDateString('en-GB', { day:'numeric', month:'short', year:'numeric', hour:'2-digit', minute:'2-digit' })}</p>
  </div>
</body>
</html>`;
